...
{
    public class GBLFueraNivelesConfiguration: System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<GBLFueraNiveles>
    {
        public GBLFueraNivelesConfiguration()
            : this("dbo")
        {
        }

        public GBLFueraNivelesConfiguration(string schema)
        {
            ToTable("TBL_GBL_FUERA_NIVELES", schema);
            HasKey(x => new { x.Id });
            ...
            Property(x => x.Movil1).HasColumnName(@"MOVIL_1").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
            Property(x => x.Movil2).HasColumnName(@"MOVIL_2").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
            Property(x => x.MovilPostpago).HasColumnName(@"MOVIL_POSTPAGO").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
