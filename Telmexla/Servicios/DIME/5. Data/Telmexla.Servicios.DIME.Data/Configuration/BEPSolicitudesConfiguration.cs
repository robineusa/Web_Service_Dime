...
{
    public class BEPSolicitudesConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<BEPSolicitudes>
    {
        public BEPSolicitudesConfiguration()
            : this("dbo")
        { }
        public BEPSolicitudesConfiguration(string schema)
        {
            ToTable("TBL_BEP_SOLICITUDES", schema);
