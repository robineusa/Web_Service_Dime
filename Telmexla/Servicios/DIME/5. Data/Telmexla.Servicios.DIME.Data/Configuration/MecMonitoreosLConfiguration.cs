...
{
    public class MecMonitoreosLConfiguration: System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<MecMonitoreosL>
    {
        public MecMonitoreosLConfiguration()
            : this("dbo")
        { }
        public MecMonitoreosLConfiguration(string schema)
        {
            ToTable("TBL_MEC_MONITOREOS_LOG", schema);
            HasKey(x => new { x.Id });
