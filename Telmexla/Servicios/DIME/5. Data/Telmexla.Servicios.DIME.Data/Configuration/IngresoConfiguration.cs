...
namespace Telmexla.Servicios.DIME.Data.Configuration
{
    ...
    public class IngresoConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Ingreso>
    {
        ...
        public IngresoConfiguration(string schema)
        {
            ...
            Property(x => x.Estrato).HasColumnName(@"ESTRATO").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(15);
            Property(x => x.TipoCliente).HasColumnName(@"TIPO_CLIENTE").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(15);
