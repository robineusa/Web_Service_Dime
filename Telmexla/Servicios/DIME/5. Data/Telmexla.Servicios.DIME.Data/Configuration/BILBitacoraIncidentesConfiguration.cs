...
{
    public class BILBitacoraIncidentesConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<BILBitacoraIncidentes>
    {
        public BILBitacoraIncidentesConfiguration()
            : this("dbo")
        { }
        public BILBitacoraIncidentesConfiguration(string schema)
        {
            ToTable("TBL_BIL_BITACORA_DE_INCIDENTES", schema);
            HasKey(x => new { x.Id });
