...
{
    public class GPMMidasConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<GPMMidas>
    {
        public GPMMidasConfiguration()
            : this("dbo")
        {
        }

        public GPMMidasConfiguration(string schema)
        {
            ToTable("TBL_GPM_MIDAS", schema);
            HasKey(x => x.Id);
