...
{
    public class BitacoraIncidentesConfiguration: System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<BitacoraIncidentes>
    {
        public BitacoraIncidentesConfiguration()
            : this("dbo")
        { }
        public BitacoraIncidentesConfiguration(string schema)
        {
            ToTable("TBL_BITACORA_DE_INCIDENTES", schema);
