...
{
    public class GBLDocsisConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<GBLDocsis>
    {
        public GBLDocsisConfiguration()
            : this("dbo")
        { }
        public GBLDocsisConfiguration(string schema)
        {
            ToTable("TBL_GBL_DOCSIS_OVERLAP", schema);
            HasKey(x => new { x.Id });
