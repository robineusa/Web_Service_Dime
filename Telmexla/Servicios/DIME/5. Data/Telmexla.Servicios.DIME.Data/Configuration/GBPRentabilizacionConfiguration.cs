...
{
    public class GBPRentabilizacionConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<GBPRentabilizacion>
    {
        public GBPRentabilizacionConfiguration()
            : this("dbo")
        { }
        public GBPRentabilizacionConfiguration(string schema)
        {
            ToTable("TBL_GBP_RENTABILIZACION", schema);
            HasKey(x => new { x.Id });
