...
{
    public class GBPProductoConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<GBPProducto>
    {
        public GBPProductoConfiguration()
            : this("dbo")
        { }
        public GBPProductoConfiguration(string schema)
        {
            ToTable("TBL_GBP_PRODUCTO", schema);
            HasKey(x => new { x.Id });
