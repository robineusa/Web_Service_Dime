...
{
    public class CEPMatrizLiberacionHHPPConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CEPMatrizLiberacionHHPP>
    {
        public CEPMatrizLiberacionHHPPConfiguration()
            : this("dbo")
        {
        }

        public CEPMatrizLiberacionHHPPConfiguration(string schema)
        {
            ToTable("TBL_CEP_MATRIZ_LIBERACION_HHPP", schema);
