...
namespace Telmexla.Servicios.DIME.Data.Configuration
{
    public class GestionMatrizConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<GestionMatriz>
    {
        ...
        public GestionMatrizConfiguration(string schema)
        {
            ...
            Property(x => x.OrdenTrabajo).HasColumnName(@"ORDEN_DE_TRABAJO").IsRequired().HasColumnType("numeric");
            ...
            Property(x => x.NombreConjuntoEdificio).HasColumnName(@"NOMBRE_CONJUNTO_EDIFICIO").IsRequired().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
            Property(x => x.TelefonoCLiente).HasColumnName(@"TELEFONO_CLIENTE").IsRequired().IsUnicode(false).HasColumnType("varchar").HasMaxLength(20);
            Property(x => x.TelefonoAdministrador).HasColumnName(@"TELEFONO_ADMINISTRADOR").IsRequired().IsUnicode(false).HasColumnType("varchar").HasMaxLength(20);
            Property(x => x.NombreAdministrador).HasColumnName(@"NOMBRE_ADMINISTRADOR").IsRequired().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
