...
{
    //TBL_TRASLADO_NO_COBERTURA
    public class TrasladoNoCoberturaConfiguration: System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<TrasladoNoCobertura>
    {
        public TrasladoNoCoberturaConfiguration()
            : this("dbo")
        {
        }

        public TrasladoNoCoberturaConfiguration(string schema)
        {
            ToTable("TBL_TRASLADO_NO_COBERTURA", schema);
            HasKey(x => new { x.Id });
