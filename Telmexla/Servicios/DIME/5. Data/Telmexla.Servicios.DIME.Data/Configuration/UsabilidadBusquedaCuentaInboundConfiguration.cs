...
{
    class UsabilidadBusquedaCuentaInboundConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<UsabilidadBusquedaCuentaInbound>
    {
        public UsabilidadBusquedaCuentaInboundConfiguration()
            : this("dbo")
        {
        }

        public UsabilidadBusquedaCuentaInboundConfiguration(string schema)
        {
            ToTable("TBL_USABILIDAD_BUSQUEDA_CLIENTE", schema);
            HasKey(x => x.Id);
