...
namespace Telmexla.Servicios.DIME.Data.Configuration
{
    ...
    public class ConvenioElectronicoConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ConvenioElectronico>
    {
        ...
        public ConvenioElectronicoConfiguration(string schema)
        {
            ...
            Property(x => x.DireccionCorrespondenciaActual).HasColumnName(@"DIRECCION_CORRESPONDENCIA_ACTUAL").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(1000);
            ...
            Property(x => x.NuevoCorreo).HasColumnName(@"NUEVO_CORREO").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(255);
            Property(x => x.NuevaDireccionCorrespondencia).HasColumnName(@"NUEVA_DIRECCION_CORRESPONDENCIA").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(1000);
