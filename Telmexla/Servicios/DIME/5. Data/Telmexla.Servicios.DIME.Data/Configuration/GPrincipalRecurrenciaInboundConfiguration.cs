...
{
    public class GPrincipalRecurrenciaInboundConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<GPrincipalRecurrenciaInbound>
    {
        public GPrincipalRecurrenciaInboundConfiguration() : this("dbo")
        {

        }
        public GPrincipalRecurrenciaInboundConfiguration(string schema)
        {
            ToTable("TBL_GPR_RECURRENCIA_INBOUND", schema);
            HasKey(x => x.Id);
