...
namespace Telmexla.Servicios.DIME.Data.Configuration
{
    ...
    // TBL_DOCSIS_OVERLAP
    public class DocsisOverlapConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<DocsisOverlap>
    {
        public DocsisOverlapConfiguration()
            : this("dbo")
        {
        }

        public DocsisOverlapConfiguration(string schema)
        {
            ToTable("TBL_DOCSIS_OVERLAP", schema);
            HasKey(x => x.Id);
