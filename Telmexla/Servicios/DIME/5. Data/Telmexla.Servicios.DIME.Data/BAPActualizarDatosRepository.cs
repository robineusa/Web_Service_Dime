...
{
    public class BAPActualizarDatosRepository: Repository<BAPActualizarDatos>, IBAPActualizarDatosRepository
    {
        public BAPActualizarDatosRepository(DimeContext context) : base(context)
        {
