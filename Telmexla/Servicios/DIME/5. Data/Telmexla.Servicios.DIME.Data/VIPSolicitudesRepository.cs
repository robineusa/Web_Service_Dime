...
{
    public class VIPSolicitudesRepository: Repository<VIPSolicitudes>, IVIPSolicitudesRepository
    {
        public VIPSolicitudesRepository(DimeContext context) : base(context){}
