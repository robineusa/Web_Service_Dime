...
namespace Telmexla.Servicios.DIME.WebServices
{
    public class RecurrenciaService
    {
        ...
        {
            RecurrenciaBusiness recurrenciaBusiness = new RecurrenciaBusiness();
            return recurrenciaBusiness.TraerDatosRecurrenciaCarga(CuentaCliente);
        }
        public void ActualizarUusuarioGestionando(int Usuario, decimal Cuenta)
        {
            RecurrenciaBusiness recurrenciaBusiness = new RecurrenciaBusiness();
            recurrenciaBusiness.ActualizarUusuarioGestionando(Usuario, Cuenta);
        }
        public List<GPrincipalRecurrencia> CuentaGprincipalRecurrencia(int CuentaCliente)
        {
            RecurrenciaBusiness recurrenciaBusiness = new RecurrenciaBusiness();
            return recurrenciaBusiness.CuentaGprincipalRecurrencia(CuentaCliente);
        }
        public List<GLogRecurrencia> ListaMiHistorialRecurrencia(string usuarioGestion)
        {
            RecurrenciaBusiness recurrenciaBusiness = new RecurrenciaBusiness();
            return recurrenciaBusiness.ListaMiHistorialRecurrencia(usuarioGestion);
        }
        public GPrincipalRecurrencia TraerGPrinRecurrenciaid(int CuentaCliente, int id)
        {
            RecurrenciaBusiness recurrenciaBusiness = new RecurrenciaBusiness();
            return recurrenciaBusiness.TraerGPrinRecurrenciaid(CuentaCliente, id);
        }
    }
}
