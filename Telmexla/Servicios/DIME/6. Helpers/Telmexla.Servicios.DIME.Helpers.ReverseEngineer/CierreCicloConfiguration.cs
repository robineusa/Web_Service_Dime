...
namespace Telmexla.Servicios.DIME.Helpers.ReverseEngineer
{
    ...
    public class CierreCicloConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CierreCiclo>
    {
        public CierreCicloConfiguration()
            : this("dbo")
        {
        }

        public CierreCicloConfiguration(string schema)
        {
            ToTable("TBL_CIERRE_CICLO", schema);
            HasKey(x => x.Id);
