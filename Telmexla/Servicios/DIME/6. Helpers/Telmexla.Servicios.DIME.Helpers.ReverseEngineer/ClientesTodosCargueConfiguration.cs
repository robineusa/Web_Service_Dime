...
namespace Telmexla.Servicios.DIME.Helpers.ReverseEngineer
{
    ...
    public class ClientesTodosCargueConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ClientesTodosCargue>
    {
        public ClientesTodosCargueConfiguration()
            : this("dbo")
        {
        }

        public ClientesTodosCargueConfiguration(string schema)
        {
            ToTable("TBL_CLIENTES_TODOS_CARGUE", schema);
            HasKey(x => x.Cuenta);
