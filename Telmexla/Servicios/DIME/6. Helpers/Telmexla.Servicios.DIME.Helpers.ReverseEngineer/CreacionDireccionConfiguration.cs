...
namespace Telmexla.Servicios.DIME.Helpers.ReverseEngineer
{
    ...
    public class CreacionDireccionConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CreacionDireccion>
    {
        ...
        public CreacionDireccionConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.TransaccionesTraslado).WithMany(b => b.CreacionDireccions).HasForeignKey(c => c.IdTransaccion).WillCascadeOnDelete(false); // FK__TBL_CREAC__ID_TR__4B0D20AB
        }
    }
