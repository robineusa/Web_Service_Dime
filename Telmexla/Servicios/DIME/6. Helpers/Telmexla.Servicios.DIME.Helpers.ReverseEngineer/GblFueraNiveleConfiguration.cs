...
namespace Telmexla.Servicios.DIME.Helpers.ReverseEngineer
{
    ...
    public class GblFueraNiveleConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<GblFueraNivele>
    {
        public GblFueraNiveleConfiguration()
            : this("dbo")
        {
        }

        public GblFueraNiveleConfiguration(string schema)
        {
