...
namespace Telmexla.Servicios.DIME.Helpers.ReverseEngineer
{
    ...
    // TBL_CLIENTES_TODOS_CARGUE
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.24.0.0")]
    public class ClientesTodosCargue
    {
        ...
        public string Celular1 { get; set; } // CELULAR_1 (length: 255)
        public string Celular2 { get; set; } // CELULAR_2 (length: 255)
        public string TelefonoConv { get; set; } // TELEFONO_CONV (length: 255)
        public string DirInstalacion { get; set; } // DIR_INSTALACION (length: 1000)
        public string DirCorrespondencia { get; set; } // DIR_CORRESPONDENCIA (length: 1000)
        public string Correo { get; set; } // CORREO (length: 255)
        ...
        public string Convenio { get; set; } // CONVENIO (length: 255)
        public string Cortesia { get; set; } // CORTESIA (length: 255)
        public string SrvHd { get; set; } // SRV_HD (length: 255)
        public double? NumSrvBasicos { get; set; } // NUM_SRV_BASICOS
        public string Dth { get; set; } // DTH (length: 255)
        public string Clarovideo { get; set; } // CLAROVIDEO (length: 255)
        public string CategoriaRenta { get; set; } // CATEGORIA_RENTA (length: 255)
    }
