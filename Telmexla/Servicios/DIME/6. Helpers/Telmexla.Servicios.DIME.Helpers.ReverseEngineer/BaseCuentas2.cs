...
namespace Telmexla.Servicios.DIME.Helpers.ReverseEngineer
{
    ...
    public class BaseCuentas2
    {
        ...
        public string Celular1 { get; set; } // CELULAR_1 (length: 40)
        public string Celular2 { get; set; } // CELULAR_2 (length: 40)
        ...
        public string Correo { get; set; } // CORREO (length: 500)
        ...
        public string Clarovideo { get; set; } // CLAROVIDEO (length: 2)
        public string UsoCv { get; set; } // USO_CV (length: 2)
        public string ActivacionClaroVideo { get; set; } // ACTIVACION_CLARO_VIDEO (length: 2)
    }
