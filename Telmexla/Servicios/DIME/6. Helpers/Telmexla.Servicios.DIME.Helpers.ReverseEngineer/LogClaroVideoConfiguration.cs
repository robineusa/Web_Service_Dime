...
namespace Telmexla.Servicios.DIME.Helpers.ReverseEngineer
{
    ...
    public class LogClaroVideoConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<LogClaroVideo>
    {
        public LogClaroVideoConfiguration()
            : this("dbo")
        {
        }

        public LogClaroVideoConfiguration(string schema)
        {
            ToTable("TBL_LOG_CLARO_VIDEO", schema);
            HasKey(x => x.Id);
