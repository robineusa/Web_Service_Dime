...
namespace Telmexla.Servicios.DIME.Helpers.ReverseEngineer
{
    ...
    public class LogConvenioElectronicoConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<LogConvenioElectronico>
    {
        public LogConvenioElectronicoConfiguration()
            : this("dbo")
        {
        }

        public LogConvenioElectronicoConfiguration(string schema)
        {
            ToTable("TBL_LOG_CONVENIO_ELECTRONICO", schema);
            HasKey(x => x.Id);
